...
$toemails[] = array(
				'email' => 'mggbangkok@medgicgroup.com', // Your Email Address
...
$fromemail = array(
				'email' => 'no-reply@medgicgroup.com', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'BGG' // Company Name
			);
